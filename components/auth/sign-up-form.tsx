...
export function SignUpForm() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      toast({
        ...
        description: "You've successfully signed up for SkillX",
      })
  ...
  async function signUpWithGithub() {
    ...
    try {
      ...
      if (isNewUser) {
        // For new GitHub users, go to role selection
        router.push("/role-selection")
      } else {
        // Existing user, go to dashboard
        router.push("/dashboard")
  ...
  return (
    <div className="grid gap-6">
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <Select onValueChange={field.onChange} defaultValue={field.value}>
                  ...
                  <SelectContent>
                    <SelectItem value="freelancer">Freelancer (Service Provider)</SelectItem>
      ...
      <div className="grid grid-cols-2 gap-4">
        <Button variant="outline" disabled={isLoading} onClick={signUpWithGoogle}>
          <svg
        ...
        <Button variant="outline" disabled={isLoading} onClick={signUpWithGithub}>
          <svg
            className="mr-2 h-4 w-4"
            aria-hidden="true"
            focusable="false"
