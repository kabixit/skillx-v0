...
const features = [
  {
    ...
    description: "Trade your expertise for services you need without traditional payment.",
    icon: (
      <svg
  ...
  },
  {
    ...
    description: "Showcase your expertise with verifiable credentials and peer reviews.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
  ...
  },
  {
    ...
    description: "Track milestones, collaborate seamlessly, and complete projects efficiently.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
